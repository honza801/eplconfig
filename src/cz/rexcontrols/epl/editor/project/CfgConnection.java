 ...
 *       &lt;sequence>
 *         &lt;element name="Source" type="{}CfgDataIdent"/>
 *         &lt;element name="Destination" type="{}CfgDataIdent" maxOccurs="unbounded"/>
...
public class CfgConnection {
     ...
     *     
     */
    public void setSource(CfgDataIdent value) {
        this.source = value;
    }
    ...
    public List<CfgDataIdent> getDestination() {
        if (destination == null) {
            destination = new ArrayList<CfgDataIdent>();
        }
