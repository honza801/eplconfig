 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ethernet-powerlink.org}functionType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "functionTypeList")
public class FunctionTypeList {

    @XmlElement(required = true)
    protected List<FunctionType> functionType;
    ...
    public List<FunctionType> getFunctionType() {
        if (functionType == null) {
            functionType = new ArrayList<FunctionType>();
        }
